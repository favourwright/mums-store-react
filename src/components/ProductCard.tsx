...
const ProductCard = ({ className, id, image, name, rating=(0.0), price, currency='₦' }: Props)=>{
  ...
  return (
    <div
      className={`${className} group w-[250px] h-[320px] flex flex-col gap-3
      border border-secondary/10 dark:border-white/10 rounded-3xl
      hover:bg-complementary/30 hover:dark:bg-complementary/10
      hover:scale-105 hover:border-transparent
      transition-all duration-300 hover:shadow-2xl relative
      hover:shadow-black/10 hover:dark:shadow-black/20`}
